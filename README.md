...
## ✍️ Descrição
Exemplificação da sintaxe geral e básica da Linguagem PYTHON
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/basic-python.git
    ```
1. Download:
    ### Download Manual
...
## 👋🏽 DEMO
[REPLIT](https://replit.com/@cleibp/Basic-Python) 
